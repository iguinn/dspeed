...
def build_dsp(
    ...
    with ExitStack() as stack:
        ...
        raw_store = stack.enter_context(lh5.LH5Store(keep_open=True, default_mode="r"))
        ...
        if dsp_out is None:
            ...
            dsp_st = stack.enter_context(lh5.LH5Store(keep_open=True, default_mode=wo_mode))
        ...
        for tb in lh5_tables:
            ...
            if this_config is None:
                log.info(f"No config found for {tb}; skipping...")
                continue
